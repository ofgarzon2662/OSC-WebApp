...
// Size limits
const MAX_SINGLE_FILE_SIZE = 60 * 1024 * 1024;  // 20MB for single files
const MAX_FOLDER_SIZE = 60 * 1024 * 1024;       // 20MB for folders
const MAX_FILES_IN_FOLDER = 100;                 // Maximum files in a folder
